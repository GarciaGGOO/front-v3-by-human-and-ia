...
export const NotificationDropdown: React.FC<NotificationDropdownProps> = ({
  ...
  return (
    <Container bordered={false}>
      <div className="absolute right-0 mt-2 w-80 border border-gray-200 rounded-md shadow-lg bg-white text-black z-50 dark:bg-gray-800 dark:text-white dark:border-gray-700">
            ...
            notifications.map((notification, index) => (
              <div
                ...
                className={cn(
                  ...
                  index === notifications.length - 1 && "rounded-b-lg", // Aplica rounded-b-lg no último item
